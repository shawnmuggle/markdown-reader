...
- 📄 **Renders local files directly** — drag a `.md` into Chrome, or open a `file://` path to a Markdown file, and it renders automatically
...
- 📦 **Fully offline** — all dependencies are bundled locally, no CDN or network required
